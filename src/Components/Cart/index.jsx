...
export default function Cart() {
  ...
  const createCheckout = async () => {
    ...
    if (lineItems.length === 0) {
      dispatch(
        showAlert(
          'Your cart is empty, please add products to continue to checkout.'
        )
      )
      return
    }
      ...
      await onSnapshot(docRef, async (doc) => {
        ...
        if (sessionId) {
          const stripe = await loadStripe(
            'pk_test_51NNCqXKUtXesZvVb2fpF5NesqqvITDuYNWtIXEZsw5PrXl2gTdygp7hWhyaGjW5Jl2xtopXf0Cz9jhLsGCUrXUAR00FwIjkVjw'
          )
  ...
  return (
    ...
    >
      ...
      <Modal.Footer>
        ...
        <Button className="checkout-btn" onClick={() => createCheckout()}>
          Go to Checkout
        </Button>
      </Modal.Footer>
    </Modal>
